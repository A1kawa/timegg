function calcTimeDays(timeInSeconds: number): Array<number|string> {
    ...
    let minutes: number = Math.floor((timeInSeconds - (hours * 3600) - (days * 86400)) / 60);
    ...
    console.log(`o tempo foi formatado em ${daysFormat} dias, ${hoursFormat} horas, ${minutesFormat} minutos e ${secondsFormat} segundos`)
    return [
        daysFormat,
        hoursFormat,
        minutesFormat,
